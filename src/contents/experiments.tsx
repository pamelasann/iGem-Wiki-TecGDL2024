        ...
        <div className="col-lg-3 col-md-12 pt-5 ps-5" id="menu-container">
            <div id="titles-container">
              <ul className="list-unstyled">
                ...
                <li className="ps-4">
                  <a href="#part2">Miniprep QIAGEN QIAprep Spin kit</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part3">Miniprep Promega Wizard SV kit</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part4">Agarose gel electrophoresis</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part5">Transformation by electroporation</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part6">Transformation by heat shock</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part7">Electrocompetent cells</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part8">Chemically competent cells</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part9">Restriction digestion</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part10">PCR w/DreamTaq polymerase</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part11">PCR w/GoTaq Green Master Mix</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part12">Gel extraction - Invitrogen PureLink Quick</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part13">Fluorescent protein washes</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part14">PCR purification - QIAquick PCR Purification Kit </a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part15">Ligation - Invitrogen T4 ligase</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part16">Gibson Assembly - NEB Gibson Assembly Master Mix</a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
                ...
                <li className="ps-4">
                  <a href="#part18">Induction and SDS-PAGE gel electrophoresis </a>
                  <ul className="list-unstyled">
                    <li className="ps-4">
                    </li>
                  </ul>
          ...
          <div className="col-lg-9 col-md-12" id="main-content-container">
            <div className="container-fluid" id="text-content">
              <div className="container-fluid p-3" id="part1">
                <h1>Protocols</h1>
              ...
              <div className="container-fluid p-3 mt-5" id="part2">
                ...
                <ol>
                  ...
                  <li>Measure plasmid DNA yield in Nanodrop, using as a blank 3 μL of Buffer EB. Store plasmid DNA at -20 °C.
                  </li>
                </ol>
              </div>
