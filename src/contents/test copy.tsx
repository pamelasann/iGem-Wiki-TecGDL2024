...
// Importa KaTeX para las ecuaciones LaTeX
    ...
    <>
      <div className="container-fluid p-3">
        <div className="row">
          ...
          items={[
            {
              mainPart: { title: "Protocols", id: "protocols" },
              subParts: [
                { title: "Miniprep QIAGEN QIAprep Spin kit", id: "qiagen-spin-kit" },
                { title: "Miniprep Promega Wizard SV kit", id: "promega-kit" },
                { title: "Agarose gel electrophoresis", id: "agarose-gel-electrophoresis" },
              ],
            },
            {
              mainPart: { title: "Transformation", id: "transformation" },
              subParts: [
                { title: "Transformation by electroporation", id: "transformation-electroporation" },
                { title: "Transformation by heat shock", id: "transformation-heat-shock" },
                { title: "Electrocompetent cells", id: "electrocompetent-cells" },
              ],
            },
            {
              mainPart: { title: "PCR and Digestion", id: "pcr-digestion" },
              subParts: [
                { title: "Restriction digestion", id: "restriction-digestion" },
                { title: "PCR w/DreamTaq polymerase", id: "pcr-dreamtaq-polymerase" },
                { title: "PCR w/GoTaq Green Master Mix", id: "pcr-gotag-green-master-mix" },
              ],
            },
            {
              mainPart: { title: "Gel and Ligation", id: "gel-ligation" },
              subParts: [
                { title: "Gel extraction - Invitrogen PureLink Quick", id: "gel-extraction-invitrogen" },
                { title: "Ligation - Invitrogen T4 ligase", id: "ligation-invitrogen" },
                { title: "Gibson Assembly - NEB Gibson Assembly Master Mix", id: "gibson-assembly-neb" },
              ],
            },
            {
              mainPart: { title: "Protein and Quality Control", id: "protein-quality-control" },
              subParts: [
                { title: "Fluorescent protein washes", id: "fluorescent-protein-washes" },
                { title: "PCR purification - QIAquick PCR Purification Kit", id: "pcr-purification-qiaquick" },
          ...
          <div className="col-lg-9 col-md-12" id="main-content-container">
            <div className="container-fluid" id="text-content">
              ...
              <section id="protocols" className="parts-container">
                ...
                <div className="container-fluid p-3 mt-5" id="qiagen-spin-kit">
                ...
                <div className="container-fluid p-3 mt-5" id="promega-kit">
              ...
              <section id="transformation" className="parts-container">
            {/* Add your content here */}

            <div className="container-fluid p-3 mt-5" id="transformation-electroporation">
              ...
              <div className="container-fluid p-3 mt-5" id="transformation-heat-shock">
              ...
              <div className="container-fluid p-3 mt-5" id="electrocompetent-cells">
          ...
          <section id="pcr-digestion" className="parts-container"> 
          <div className="container-fluid p-3 mt-5" id="restriction-digestion">
              ...
              <div className="container-fluid p-3 mt-5" id="pcr-dreamtaq-polymerase">
              ...
              <div className="container-fluid p-3 mt-5" id="pcr-gotag-green-master-mix">
          ...
          <section id="gel-ligation" className="parts-container">

          </section>
          <section id="protein-quality-controlz" className="parts-container">
          <div className="container-fluid p-3 mt-5" id="induction-sds-page">
