        ...
        <div className="row">
          ...
          <div className="col-lg-9 col-md-12" id="main-content-container">
            <div className="container-fluid" id="text-content">
              ...
              <section id="project-setup" className="parts-container">
              ...
              <section id="dna-manipulation" className="parts-container">
          ...
          <section id="transformation-cells" className="parts-container">
            {/* Add your content here */}
          ...
          <section id="protein-analysis" className="parts-container">
            {/* Add your content here */}
          ...
          <section id="quality-control" className="parts-container">
            {/* Add your content here */}
